...
# Установите IP мастера
RANCHER_IP=192.168.3.52
...
echo "✅ Конфиг создан для ноды типа: worker"
```
...
# Ожидание запуска (может занять 2-5 минут)
echo "⏳ Ожидание запуска RKE2 agent..."
sleep 5
