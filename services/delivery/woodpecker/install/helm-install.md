...
### 1. Создайте .woodpecker.yml в корне репозитория:

> 📋 **Переменные автоматически создаются Woodpecker CI при каждом запуске pipeline:**
>
> - CI_REPO_NAME - название репозитория (например: stroytrack-backend)
> - CI_COMMIT_BRANCH - название ветки (например: stage, prod)
> - CI_COMMIT_SHA - полный хеш коммита (например: a1b2c3d4e5f6...)
> - CI_COMMIT_SHA:0:8 - первые 8 символов хеша (например: a1b2c3d4)
